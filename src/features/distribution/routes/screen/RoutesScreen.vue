...
import RouteFormModal from '@/features/distribution/routes/screen/RouteFormModal.vue'
import { useRoutesVm } from '@/features/distribution/routes/vm/useRoutesVm'

const vm = useRoutesVm()
</script>
  ...
  <main class="feature-screen container-fluid px-3 px-md-4 py-3 py-md-4">
    ...
    <section class="operations-layout operations-layout--single">
      <div class="feature-stack">
        <section class="metric-grid metric-grid--three" aria-label="Ringkasan rute">
        ...
        <section class="panel">
          ...
          <div class="data-table data-table--orders" role="table" aria-label="Daftar rute">
