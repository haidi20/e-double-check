...
export type SupplierFormFieldType = 'text' | 'select' | 'textarea'
...
export interface SuppliersView extends FeatureContent {
  mode: 'master'
  headingTitle: string
...
export interface SuppliersState extends FeatureContent {
  dummyData: DummyDataItem[]
  view: SuppliersView
}
