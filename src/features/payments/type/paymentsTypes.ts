...
export type PaymentFormFieldType = 'text' | 'select' | 'textarea'
...
export interface PaymentsView extends FeatureContent {
  mode: 'operations'
  headingTitle: string
...
export interface PaymentsState extends FeatureContent {
  dummyData: DummyDataItem[]
  view: PaymentsView
}
