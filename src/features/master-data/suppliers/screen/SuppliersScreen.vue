...
import SupplierFormModal from '@/features/master-data/suppliers/screen/SupplierFormModal.vue'
import { useSuppliersVm } from '@/features/master-data/suppliers/vm/useSuppliersVm'

const vm = useSuppliersVm()
</script>
...
<template>
  <main class="feature-screen container-fluid px-3 px-md-4 py-3 py-md-4">
    ...
    <section class="panel">
      ...
      <div class="data-table data-table--master" role="table" aria-label="Data pemasok">
