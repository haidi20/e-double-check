...
export type EmployeeFormFieldType = 'text' | 'select' | 'textarea'
...
export interface EmployeesView extends FeatureContent {
  mode: 'employee'
  headingTitle: string
...
export interface EmployeesState extends FeatureContent {
  dummyData: DummyDataItem[]
  view: EmployeesView
}
