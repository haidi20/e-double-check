...
usePageShortcuts([
  { commandId: 'page.services.new', handler: () => vm.openCreateModal() }
])
</script>
  ...
  <main class="feature-screen container-fluid px-3 px-md-4 py-3 py-md-4">
    <section class="page-heading">
      ...
      <button
        ...
        :title="`Tambah Layanan (${shortcutsVm.getBindingFor('page.services.new')})`"
        :aria-keyshortcuts="shortcutsVm.getBindingFor('page.services.new') ?? undefined"
