...
export type RouteFormFieldType = 'text' | 'select' | 'textarea'
...
export interface RoutesView extends FeatureContent {
  mode: 'operations'
  headingTitle: string
  ...
  formFields: RouteFormField[]
}

export interface RoutesState extends FeatureContent {
  dummyData: DummyDataItem[]
  view: RoutesView
}
