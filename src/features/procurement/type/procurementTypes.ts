...
export type OperationFormFieldType = 'text' | 'select' | 'textarea'

export interface OperationFormField {
  id: string
  label: string
  type: OperationFormFieldType
  value: string
  readonly?: boolean
  rows?: number
  wide?: boolean
...
export interface ProcurementView extends FeatureContent {
  mode: 'operations'
  headingTitle: string
...
export interface ProcurementState extends FeatureContent {
  dummyData: DummyDataItem[]
